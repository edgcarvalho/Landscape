...
<body>
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/CapaCultura.png" class="d-block w-100" alt="...">
                </div>
    ...
    <section id="scroll">
        <div class="container px-5">
            ...
            $A = "SELECT * FROM tbl_cad_viagem where personalidade_viagem = 4";
                ...
                if ($stmt->execute()) {
                    while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
                        ...
                        <div class="row gx-5 align-items-center">
                            <div class="col-lg-6">
                                <!-- //inserir as Imagens -->
                                <img style="width:500px; height:350px" src="upload/<?php echo $rs->file_img; ?>">
